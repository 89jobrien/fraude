// TODO(unit): no tests — add unit tests for BootstrapPhase ordering and elapsed()
//   timing logic; property test that phases are monotonically non-decreasing in time
