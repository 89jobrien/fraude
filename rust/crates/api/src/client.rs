...
use crate::providers::fraude_provider::{self, AuthSource, FraudeApiClient};
...
impl ProviderClient {
    ...
    pub fn from_model_with_default_auth(
        ...
        match providers::detect_provider_kind(&resolved_model) {
            ProviderKind::FraudeApi => Ok(Self::FraudeApi(match default_auth {
                Some(auth) => FraudeApiClient::from_auth(auth),
                None => FraudeApiClient::from_env()?,
            })),
    ...
    pub const fn provider_kind(&self) -> ProviderKind {
        match self {
            Self::FraudeApi(_) => ProviderKind::FraudeApi,
    ...
    pub async fn send_message(
        ...
        match self {
            Self::FraudeApi(client) => send_via_provider(client, request).await,
    ...
    pub async fn stream_message(
        ...
        match self {
            Self::FraudeApi(client) => stream_via_provider(client, request)
                .await
                .map(MessageStream::FraudeApi),
...
pub enum MessageStream {
    FraudeApi(fraude_provider::MessageStream),
...
impl MessageStream {
    ...
    pub fn request_id(&self) -> Option<&str> {
        match self {
            Self::FraudeApi(stream) => stream.request_id(),
    ...
    pub async fn next_event(&mut self) -> Result<Option<StreamEvent>, ApiError> {
        match self {
            Self::FraudeApi(stream) => stream.next_event().await,
